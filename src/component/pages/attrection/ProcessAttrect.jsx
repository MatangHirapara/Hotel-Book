...
const ProcessAttrect = () => {
  ...
  const childplus = () => {
    dispatch(inccount())
    setChild((mychild >= 1) ? (childs * 2) : (childs * 1))
  ...
  const adultplus = () => {
    dispatch(incNum())
    setAdult(mystate > 1 ? adult * 2 : adult * 1)
              ...
              <div className='detailTotal' id='counter'>
                ...
                <div className='Total' >
                  <div className='Totalfirst' >
                    <div>
                      <p>Adult (age 13-99)</p>
                      <p style={{ marginTop: "-1rem" }} >Rs. {mystate > 0 ? adult : 0}</p>
                    </div>
                  ...
                  <div className='Totalfirst' >
                    <div>
                      <p>child (age 4-12)</p>
                      <p style={{ marginTop: "-1rem" }} >Rs. {mychild > 0 ? childs : 0}</p>
                    </div>
                    <div style={{ width: "8vw", display: "flex", alignItems: "center", justifyContent: "space-between" }} >
                ...
                <div className='IditemPrice' >
                  ...
                  <div className='IdbookPrice' >
                    <div>
                      ...
                      <p>Rs. {mystate > 0 ? adult : 0}</p>
                    </div>
                    <div>
                      <p>{mychild}X Child (age 4-12)</p>
                      <p>Rs. {mychild > 0 ? childs : 0}</p>
                    </div>
                    <br />
