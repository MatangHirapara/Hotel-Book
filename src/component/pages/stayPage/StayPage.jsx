    ...
    <>
      <div className='staypage' >
        <div className='staymain' >
          ...
          <div className='state'>
            <div className='select' onClick={click} >
              ...
              <Button onClick={search} style={{marginLeft: "2rem",fontSize: "18px",width: "255px",borderRadius: "5px",color: "white",backgroundColor: "#0077ff"}} >Search</Button>
        </div>
        ...
        <div className='stayjorny' >
          <div className='jorny' >
            <img src={jorny_1} alt="" />
            <span>Manchester <br /><p>1,096 Properties</p> </span>
            <img src={jorny_2} alt="" />
          </div>
        </div>
